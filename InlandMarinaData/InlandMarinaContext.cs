...
namespace InlandMarinaData
{
	public class InlandMarinaContext : DbContext
	{
		...
		//public DbSet<User> Users { get; set; } // for the added class
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Customer>().HasData(
				new Customer { ID = 1, FirstName = "John", LastName = "Doe", Username="jdoe", Password="password", 
					Phone = "265-555-1212", City = "Phoenix" },
				new Customer { ID = 2, FirstName = "Sara", LastName = "Williams", Username = "swilliams", Password = "password", 
					Phone = "403-555-9585", City = "Calgary" },
				new Customer { ID = 3, FirstName = "Ken", LastName = "Wong", Username = "kwong", Password = "password", 
					Phone = "802-555-3214", City = "Kansas City" }
			);
